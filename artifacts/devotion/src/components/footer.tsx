      ...
      <div className="container py-12">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div className="md:col-span-1">
            ...
            <ul className="mt-3 space-y-2 text-sm text-gray-500">
              <li>
                <Link href="/#tools" className="hover:text-gray-900">Browse Tools</Link>
              </li>
              <li>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-gray-200 pt-8 md:flex-row">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://twitter.com" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-gray-600">
