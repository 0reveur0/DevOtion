          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-10 flex items-center justify-center gap-8 text-sm text-gray-600">
              <div className="flex items-center gap-2">
                ...
                <span><strong>500+</strong> Tools</span>
              </div>
              <div className="flex items-center gap-2">
                <RiCheckboxCircleLine className="h-5 w-5 text-green-600" />
                <span><strong>10,000+</strong> Reviews</span>
              </div>
              <div className="flex items-center gap-2">
                <RiCheckboxCircleLine className="h-5 w-5 text-green-600" />
                <span><strong>100%</strong> Open Source</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {CATEGORIES.map((category) => (
              <CategoryCard
                key={category.slug}
                category={category}
                toolCount={TOOLS_BY_CATEGORY[category.slug as keyof typeof TOOLS_BY_CATEGORY]?.length || 0}
              />
            ))}
          </div>
        </div>
      ...
      <section id="tools" className="border-t border-gray-200 bg-gray-50 py-20">
        <div className="container">
          <div className="mb-10 flex items-center justify-between">
            ...
            <CustomButton variant="outline" className="hidden sm:flex">
              View All Tools
      ...
      <section className="border-t border-gray-200 py-20">
        <div className="container text-center">
          ...
          <div className="mt-8 flex justify-center gap-4">
            <CustomButton size="lg">Sign in with GitHub</CustomButton>
            <CustomButton variant="outline" size="lg">Learn More</CustomButton>
          </div>
        </div>
      </section>
    </div>
